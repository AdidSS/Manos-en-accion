...
### Ejecución:
En el Script real_time_predictions.py en la línea 204 seleccionar el índice de la cámara que vas a usar.

Debido a que se estaba utilizando en una webcam, el índice de VideoCapture recibe un 1. Si vas a utilizar la cámara de tu laptop generalmente es el 0.

Asegúrate de colocar el índice correcto de tu cámara para no tener errores de ejecución.
   ```python
